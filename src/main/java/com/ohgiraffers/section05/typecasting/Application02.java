...
//        float fnum = dnum;
        ...
        System.out.println("ch3 = " + ch3); // ﾟ 으로출력 마이너스 출력안됌 마이너스가 없기 때문 문자는
