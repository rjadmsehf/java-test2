...
public class Application01 {
    public static void main(String[] args) {
       ...
       /* 필기
           상수란?
           변수가 메모리에 변경 될 값을 지정하기 위한 공간을 나타낸다면, 상수는 이와 상반되는 개념이다.
           변하지 않을 값을 (넌 이걸로 끝이야) 저장해두기 위한 메모리상의 공간을 상수라고 한다.
          ...
          필기
            ...
            */
        /* 필기
            1. 상수를 선언한다.(변수 선언과 유사하지만, fibal 키워드를 사용한다.
...
//        AGE = 30;  //필기 한 번 초기화 한 이후 값을 재 대입하는 것은 불가 !!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        System.out.println("AGE의 2배는" + (AGE *2));  //필기 : 곱셈 먼저되는듯
